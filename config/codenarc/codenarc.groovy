...
ruleset {
    ...
    //ClassJavadoc // TODO - Enable at end and fix and check applyToNonMainClasses
    ...
    ImplicitClosureParameter {
        allowUsingItAsParameterName = true
    }
    ...
    AbstractClassWithoutAbstractMethod {
        // Spock feature tests don't seem to support inheritance; however,
        // the base class must be abstract such that it is not directly run.
        doNotApplyToClassNames = '*Spec'
    }
    ...
    CloseWithoutCloseable {
        enhancedMode = false // TODO - Check this again...
    }
...
//    UnsafeImplementationAsMap
    ...
    ThrowError
    ThrowException {
        // In tests, we throw unexpected exceptions to test error handling.
        doNotApplyToClassNames = '*Spec'
    }
    ...
    ConfusingMethodName
    FactoryMethodName {
        // createXxx is used as a factory method name.
        regex = 'build.*,make.*'
    }
    FieldName
    InterfaceName
    ...
    //NonSerializableFieldInSerializableClass // Causing failures when running
    ...
    UnnecessaryObjectReferences {
        // Rule seems to get confused with tables in Spock test where clauses.
        doNotApplyToClassNames = '*Spec'
    }
