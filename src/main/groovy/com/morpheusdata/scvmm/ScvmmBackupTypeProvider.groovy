...
/**
 * Provides a standard set of methods for a {@link com.morpheusdata.core.backup.BackupProvider}.
...
class ScvmmBackupTypeProvider extends AbstractBackupTypeProvider {
    ...
    /**
     * Indicates the type of restore supported. Current options include: new, existing, online,
     * offline, migration, failover
     ...
     *   </li>
     *   <li>
     *     VM_RESTORE -- The external backup provider restores to a VM and the core system will
     *     associate the resulting VM to the internal resources.
     *   </li>
     *   <li>
    ...
    Collection<OptionType> getOptionTypes() {
        return [] as Collection<OptionType>
    }
    ...
    ScvmmBackupExecutionProvider getExecutionProvider() {
        this.executionProvider = this.executionProvider ?: new ScvmmBackupExecutionProvider(plugin, morpheusContext)
    ...
    ScvmmBackupRestoreProvider getRestoreProvider() {
        this.restoreProvider = this.restoreProvider ?: new ScvmmBackupRestoreProvider(plugin, morpheusContext)
